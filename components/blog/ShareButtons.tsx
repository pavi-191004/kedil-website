...
export default function ShareButtons({ url, title }: Props) {
  return (
    <div className="py-6 border-t border-gray-100">
      <p className="text-sm font-semibold text-gray-900 mb-3">Share If You Like!</p>
      <div className="flex items-center gap-2">
        {shareLinks(url, title).map((link) => (
          <a
            ...
            className="w-9 h-9 rounded-xl flex items-center justify-center text-white hover:opacity-80 transition-opacity duration-150"
          >
            {link.icon}
          </a>
        ))}
